...
public abstract class NewAbstractMapper {
	
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(NewAbstractMapper.class);
	...
	public NewAbstractMapper(Class targetClass, Class... sourceClass) {
